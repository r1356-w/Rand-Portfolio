...
const projects = [
  ...
  },
  {
    ...
    description:
      "A dedicated course management system for educational institutes, built with Flutter — featuring a secure administrative portal for the institute director and real-time course browsing for students.",
    highlights: [
      "Director-only administrative portal for managing courses, content, and student access",
      "Protected login system with role-based access control",
      "Real-time, reactive course browsing UI for students",
    ],
    stack: ["Flutter", "Dart", "Authentication", "Admin Panel", "Real-time UI"],
    accent: "#A855F7",
    accentRgb: "168,85,247",
